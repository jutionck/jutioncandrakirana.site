...
export const metadata: Metadata = {
  title: 'Home',
  description: 'Full-stack developer and tech educator with 7+ years of experience. Specializing in Golang, Java Spring Boot, React, and cloud technologies. Training 500+ developers.',
};
